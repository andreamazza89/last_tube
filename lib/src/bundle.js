...
var StationSearch     = require('./stationSearch.js').StationSearch;
var ApiHandler        = require('./ApiHandler.js');
var LastJourneySearch = require('./lastJourneySearch.js').LastJourneySearch;
...
},{"./ApiHandler.js":1,"./lastJourneySearch.js":3,"./stationSearch.js":4}],3:[function(require,module,exports){
...
(function(exports) {
  ...
  StationSearch.prototype = {
    ...
    search: function(searchParameter, callback, printFieldID) {
      ...
      this._apiHandler.get(searchUrl, extractFirstStation);
  ...
  exports.StationSearch = StationSearch;
