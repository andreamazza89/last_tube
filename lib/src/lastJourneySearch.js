...
(function(exports) {
  function LastJourneySearch(ApiHandler, apiOptions) {
    ...
    this._apiQueryParams = apiOptions ? apiOptions.queryParams : '?app_id=86edcb7f&app_key=d623423387aeb5205f919ef9f8549779&mode=tube&time=0300& alternativeWalking=false&date=' + this._targetDate; 
